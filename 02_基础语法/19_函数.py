...
"""
结果是 2
实例中有 int 对象 2，指向它的变量是 b，在传递给 ChangeInt 函数时，按传值的方式复制了变量 b，a 和 b 都指向了同一个 Int 对象，在 a=10 时，
...
"""
print("----------------------------------")
def printme(str,str02):
    "打印任何传入的字符串"
    print(str,str02)
    return
# 调用printme函数
printme(str="bb",str02="cc")
